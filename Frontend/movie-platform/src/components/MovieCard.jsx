...
const MovieCard = ({ movie }) => {
  ...
  return (
    <div
      className="relative bg-[#1a1a1a] rounded-2xl overflow-hidden shadow-lg transition-all duration-500 hover:shadow-red-600/20 hover:shadow-2xl active:scale-95 cursor-pointer"
    ...
    >
      ...
      <div
        className={`absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent 
          flex flex-col justify-end p-4 transition-all duration-300
